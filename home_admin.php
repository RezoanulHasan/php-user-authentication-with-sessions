...
<body class="bg-gray-100 p-8">
    ...
    <div class="max-w-4xl mx-auto bg-white p-6 rounded shadow-lg">
        ...
        <h2 class="text-2xl    text-center text-red-500  font-bold mt-8 mb-10"> ALL User Data</h2>
        ...
        <table class="min-w-full bg-white border border-gray-300">
            <thead class="bg-gray-200">
                <tr>
                    ...
                    <th class="border px-4 py-2"> Create and Edit</th>
                </tr>
            </thead>
            <tbody>
                <?php
                    foreach ($userData as $user) {
                        ...
                        echo "<tr>
                                ...
                                <td class='border px-4 py-2'>
                                    <form method='post'>
                                        <button type='submit' name='delete' value='$email' class='bg-red-500 text-white px-2 py-1 rounded-full mr-2'>
                                            <i class='fas fa-trash'></i> Delete
                                        </button>
                                    </form>
                                    </td>
                                    <td class='border px-4 py-2'>
                                    <button type='button' class='edit-button bg-blue-500 text-white px-2 py-1 rounded-full mr-2'
                                        data-email='$email'
                                        data-role='$role'
    ...
    <div id="editModal" class="modal hidden fixed inset-0 z-50 flex items-center justify-center w-full h-full bg-black bg-opacity-50">
      <div class="modal-content bg-white p-4 rounded shadow-lg">
        ...
        <h2 class="text-2xl text-red-500 font-bold mb-4">Edit User Info</h2>
